...
<div class="container-fluid pb-3">
    <div class="d-grid gap-3" style="grid-template-columns: 1fr 2fr;">
        ...
        <div class="bg-light border rounded-3 p-3">
            ...
            <h2>Пояснение</h2>
            <p class="mb-2">
                Решение использует два цикла для заполнения массива случайными уникальными числами и вычисления сумм строк и столбцов. Далее использую функцию array_fill для создания пустого массива заданного размера и функцию mt_rand для генерации случайного числа в пределах задачи.
            </p>
            <p class="mb-2">
