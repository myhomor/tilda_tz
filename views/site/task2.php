...
<div class="container-fluid pb-3">
    <div class="d-grid gap-3" style="grid-template-columns: 1fr 2fr;">
        <div class="bg-light border rounded-3 p-3">
            ...
            <p>
                Нужно заполнить массив 5 на 7 случайными уникальными числами от 1 до 1000.<br>
        ...
        <div class="bg-light border rounded-3 p-3">
            ...
            <h2>Пояснение</h2>
            <p class="mb-2">
                Решение использует два цикла для заполнения массива случайными уникальными числами и вычисления сумм строк и столбцов. Мы используем функцию array_fill для создания пустого массива заданного размера и функцию shuffle для перемешивания массива чисел от 1 до 1000.
            </p>
            <p class="mb-2">
